...
import useRecuperarPizzaPorId from "../hooks/useRecuperarPizzaPorId";
...
const PizzaPage = () => {
  ...
  const mensagem = usePizzaStore((s) => s.mensagem);
  ...
  const {
    data: pizza,
    isPending: carregandoPizza,
    error: errorPizza,
  } = useRecuperarPizzaPorId(+id!, removido);

  const { mutate: removerPizza, error: errorRemocaoPizza } =
    useRemoverPizzaPorId();

  const tratarRemocao = (id: number) => {
    setMensagem("Pizza removido com sucesso!");
    removerPizza(id);
    setRemovido(true);
  };
  ...
  if (errorPizza) throw errorPizza;
    ...
    <>
      ...
      <div className="row">
        <div className="col-lg-3 col-md-4">
          {/* Para chegar nessa página o url foi /pizzas/:id */}
          {/* Sem a / abaixo seria enviada uma requisição para /pizzas/abacate.png*/}
          <img
            src={"/" + pizza.imagem}
        ...
        <div className="col-lg-9 col-md-8">
          <div className="row">
            ...
            <div className="col-xl-10 col-lg-9 col-8">
              {pizza.nome} ({pizza.descricao})
            </div>
            <div className="col-xl-2 col-lg-3 col-4 fw-bold mb-1">Preço</div>
            {/*
            <div className="col-xl-10 col-lg-9 col-8">
              {pizza.preco.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
            </div>
          */}
            <div className="col-xl-10 col-lg-9 col-8">
            ...
            <div className="col-xl-10 col-lg-9 col-8">{pizza.qtdEstoque}</div>
        ...
        <div className="col-lg-3 col-md-4 col-6 mt-3">
          <button
            disabled={removido}
            onClick={() => {
              setPizzaSelecionado(pizza);
              navigate("/cadastrar-pizza");
            }}
